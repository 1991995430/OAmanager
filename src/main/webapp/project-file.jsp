...
<table id="tb1" width="98%" border="1" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
...
<td height="28" colspan="12">
	...
	<a href="${pageContext.request.contextPath}/exportExcel" class="coolbg">&nbsp;导出Excel&nbsp;</a>
</td>
</tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.get("${pageContext.request.contextPath}/getAttachmentList",function (data) {
            ...
            $(data).each(function(index,ele) {
                ...
                $('#tb1 tr:eq(1)').after('<tr align=\'center\' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor=\'#FCFDEE\';" onMouseOut="javascript:this.bgColor=\'#FFFFFF\';" height="22" >\n' +
                    ...
                    '\t<td>'+ele.id+'</td>\n' +
                    '\t<td>'+ele.attname+'</td>\n' +
                    '\t<td align="center"><a href=\'\'><u>'+ele.project.pname+'</u></a></td>\n' +
                    '\t<td>3</td>\n' +
                    '\t<td>2015-02-03</td>\n' +
                    '\t<td>2015-06-03</td>\n' +
                    '\t<td><a href="${pageContext.request.contextPath}/download?fileName='+ele.path+'">下载</a> |<a href="#">删除</a> |<a href="project-file-edit.jsp">编辑</a> | <a href="project-file-look.jsp">查看详情</a></td>\n' +
                    '</tr>');
