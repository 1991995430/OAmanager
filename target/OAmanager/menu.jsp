...
<c:forEach items="${sources}" var="item">
		<dl class='bitem'>
			<dt onclick=showHide("items1_1")><b>${item.name}</b></dt>
	...
	<%--<dl class='bitem'><dt onclick=showHide('items2_1')><b>日常办公</b></dt><dd style='display:none' class='sitem' id=items2_1><ul class='sitemu' id=1>
			...
			<li><a href='message-seed.jsp' target='main'>消息推送</a> </li>
			<li><a href='mybaoxiao-base.jsp' target='main'>报销管理</a> </li>
		</ul></dd></dl>
		...
		<dl class='bitem'><dt onclick=showHide("items3_1")><b>信息箱</b></dt><dd style='display:none' class='sitem' id=items3_1><ul class='sitemu' id=2>
			<li><a href='email-send.jsp' target='main'>发信息</a> </li>
			&lt;%&ndash;<li><a href='message.jsp' target='main'>发件箱</a> </li>&ndash;%&gt;
			<li><a href='email.jsp' target='main'>收件箱</a> </li>
		</ul></dd></dl>
