...
<!--  内容列表   -->
<form name="form2" id="form14" method="post">
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
        ...
        <tr id="ttr">
            ...
            <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                <input name="url" id="surl" value="${sources.url}"/></td>
        </tr>
        <tr>
...
<script type="text/javascript">
    $(function () {
        $("#form14").submit(function () {
            ...
            $.post("${pageContext.request.contextPath}/updateInfo",parma,function (data) {
                if(data.msgCode==200){
                    alert(data.msg);
                    location.href="${pageContext.request.contextPath}/pm.jsp";
                }else{
                    alert(data.msg);
                }
            },'json');
