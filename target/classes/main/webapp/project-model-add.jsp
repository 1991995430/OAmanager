...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="analysisFk" name="analysisFk">
			<option value=-1>--请选择--</option>
		</select></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">模块名称：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input name="modname"/></td>
</tr>
<tr >
	...
	$(function () {
		...
		$('#proname').change(function () {
            ...
            $.get("${pageContext.request.contextPath}/getAnalysis?proname="+proname,function (data) {
				//alert(data);
                $(data).each(function (index,ele) {
                    $('#analysisFk').append('<option value="'+ele.id+'">'+ele.title+'</option>');
                })
            });
        ...
        $('#form2').submit(function () {
            ...
            alert(param);
            $.post('${pageContext.request.contextPath}/modelAdd',param,function (data) {
                alert(data.msg);
