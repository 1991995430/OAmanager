...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input name="functionname"/></td>
</tr>
<tr >
    ...
    $(function () {
		...
		$('#form2').submit(function () {
		   // alert("我进来了");
			...
			//alert(parma);
			$.post("${pageContext.request.contextPath}/functionAdd",parma,function (data) {
				if(data.msgCode==200){
				    alert(data.msg);
				    location.herf="${pageContext.request.contextPath}/project-function.jsp";
				}else {
                    alert(data.msg);
                    location.herf="${pageContext.request.contextPath}/project-function.jsp";
				}
